                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                       <h1 className='text-3xl font-bold text-white'>Redux</h1>
                        ...
                        <a href="#" className="py-2.5 px-5 h-9 block w-fit bg-gradient-to-r from-[#fe3976] to-[#fc63c9] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                            Contact us
                        </a>
                    </div>
